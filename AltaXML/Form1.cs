    ...
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)//import
        {
            if (openFileDialog2.ShowDialog()==DialogResult.OK)
            {
                ...
                try
                {
                    var stworkbooks = stApp.Workbooks;
                    ...
                    var stworksheet = stWorkBook.Worksheets;
                    ...
                    foreach (string item in missed_values)
                    {
                        ...
                        for (int j = 2; j <= rw; j++)
                        {
                            ...
                            if (Convert.ToString((range.Cells[j, 1] as Excel.Range).Value) != null)
                            {
                                ...
                                foreach (XmlNode node in root)
                                {
                                    ...
                                    if (node.Name == "MEASUREUNITQUALIFIERCODE")
                                    {
                                        node.InnerText = missed_values[15];
                                    }
                                    if (node.Name == "MEASUREUNITQUALIFIERNAME")
                                    {
